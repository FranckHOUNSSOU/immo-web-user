...
const TABS: { key: Tab; label: string; icon: (active: boolean) => React.ReactNode }[] = [
  { key: 'logement', label: 'Logement', icon: (a) => <IcHome /> },
  { key: 'activite', label: 'Activité',  icon: (a) => <IcChart /> },
  { key: 'messages', label: 'Messages', icon: (a) => <IcChat /> },
  { key: 'alertes',  label: 'Alertes',  icon: (a) => <IcBell /> },
  { key: 'profil',   label: 'Profil',   icon: (a) => <IcPerson /> },
]
